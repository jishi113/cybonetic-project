<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Edit Lead</h2>
    </x-slot>
                ...
                <form method="POST" action="{{ route('leads.update', $lead) }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="email" name="contact_email" value="{{ old('contact_email', $lead->contact_email) }}"
                                   class="mt-1 block w-full border rounded px-3 py-2">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="contact_phone" value="{{ old('contact_phone', $lead->contact_phone) }}"
                                   class="mt-1 block w-full border rounded px-3 py-2">
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="expected_close"
                                   value="{{ old('expected_close', $lead->expected_close?->format('Y-m-d')) }}"
                                   class="mt-1 block w-full border rounded px-3 py-2">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3" class="mt-1 block w-full border rounded px-3 py-2">{{ old('notes', $lead->notes) }}</textarea>
                    </div>

                    <div class="flex justify-end space-x-2">
                        <a href="{{ route('leads.show', $lead) }}" class="px-4 py-2 text-gray-600">Cancel</a>
